...
function queen_TEST()
{
    ...
    $queen->setCoords(3, 2);
    assertComponent(true, $queen->validateMove(2,1), "[Test 5]: перемещение с (3,2) на (2,1) возможно ");
    assertComponent(true, $queen->validateMove(3,1), "[Test 6]: перемещение с (3,2) на (3,1) возможно ");
    assertComponent(true, $queen->validateMove(2,2), "[Test 7]: перемещение с (3,2) на (2,2) возможно ");
    assertComponent(true, $queen->validateMove(4,1), "[Test 8]: перемещение с (3,2) на (4,1) возможно ");
    assertComponent(true, $queen->validateMove(2,3), "[Test 9]: перемещение с (3,2) на (2,3) возможно ");
    assertComponent(true, $queen->validateMove(4,3), "[Test 10]: перемещение с (3,2) на (4,3) возможно ");
    assertComponent(false, $queen->validateMove(5,3), "[Test 11]: перемещение с (3,2) на (5,3) невозможно ");
    unset($queen);
}
...
function rook_TEST()
{
    ...
    $rook->setCoords(3,3);
    assertComponent(true, $rook->validateMove(2,3), "[Test 5]: перемещение с (3,3) на (2,3) возможно ");
    assertComponent(true, $rook->validateMove(3,2), "[Test 6]: перемещение с (3,3) на (3,2) возможно ");
    unset($rook);
}
